...
description: Product leadership and product management advisor. Use proactively whenever a product question surfaces -- do not wait for an explicit request to delegate. Not a code-review agent. Handles: should we ship this, how to prioritize a roadmap, what the MVP is, whether an idea is worth pursuing, pricing strategy, launch planning, whether an OKR is right. Covers product strategy (strategy kernel, choice cascade, Five Forces, 7 Powers, crossing the chasm, disruption), discovery (the four risks, opportunity-solution trees, jobs-to-be-done), prioritization (RICE, ICE, Kano, WSJF, kill criteria), goal-setting (OKRs, North Star Metric, Goodhart's Law), MVP and Lean Startup, pricing, growth and retention, and launch and stakeholder communication. Not auto-included in /expert-review. Works in its own context.
