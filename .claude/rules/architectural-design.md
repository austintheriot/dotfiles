...
**Life safety is where regulation is least negotiable**, and egress, occupancy, and fire ratings shape plans before any aesthetic decision does. **Grenfell** is the reference case and the dates matter: the Phase 2 report was published **2024-09-04** and the inquiry closed 2025-02-10 (Phase 1 was 2019-10-30). Its regulatory consequence in the UK is the Building Safety Act 2022 and the "golden thread" information requirement.

**The golden thread's statutory home is regulation 31 of SI 2023/909** (the Building (Higher-Risk Buildings Procedures) (England) Regulations 2023), in force 1 October 2023 -- **not SI 2023/911**, which is real, is frequently cited for it, and actually defers to 909. It requires an electronic facility holding design documents, approved plans, compliance evidence, change-control records and prior versions, electronically transferable "without the data being lost or corrupted", accurate, readable, secure, and change-tracked.

**The regulation names properties, not formats.** No file format, schema, or interoperability standard appears in the text. That is the textual basis for the under-specification criticism, and it is visible in the drafting itself: a duty-holder can satisfy the letter with a well-organised folder of PDFs, while the evident intent -- a structured, queryable asset record -- describes something much closer to an IFC model with an IDS. **openBIM advocates and document-management vendors read the same words in opposite directions**, which is why "golden thread compliant" means very different things depending on who is selling it. One detail that transfers directly to other disciplines: **aluminium composite panel with a polyethylene core is both the Grenfell cladding and the default signage substrate**, so any specification touching ACM must ask the core-type question.
...
**Two PROBE-adjacent claims are routinely merged and should be cited separately**, because they have different evidence bases:

- **PROBE's own documented result is a spread, not a ratio**: "across the sample, there was a factor of six in carbon dioxide emissions per unit floor area, and even more per occupant." That is best-to-worst variation within the sample.
- **The familiar "twice, sometimes three times, design expectations" figure is not PROBE.** It comes from Bordass, Cohen and Field (2004) on UK non-domestic buildings generally, and that paper's external authority is a **single US building case study** (Norford et al., 1994). Use it as an illustration, not as a measured population statistic. Where detailed modelling was actually done, the average gap reported is nearer **16%**, with "up to five times" as the outer claim.

PROBE's occupant findings are the underused half: uncomfortable staff self-reported productivity **-8.8%** against comfortable staff at **+4.0%**, a 12.8-point spread, and 42% reported dissatisfaction with noise. The Elizabeth Fry Building is the sharpest single data point in the whole corpus -- a measured, previously-excellent building **resurveyed in 2011 after conversion toward open plan and higher occupant density**, with overall comfort falling from 5.41 to 5.20 and summer temperature satisfaction from 5.30 to 4.24. That is a longitudinal observation of open-plan conversion degrading a building that had been measured before it.

**Building Use Studies** began in 1985 as the Office Environment Survey by **Sheena Wilson and Alan Hedge** (4,300 workers, 50 UK buildings); Adrian Leaman consolidated and productised it and is properly credited with the BUS *methodology* rather than its origin. **Soft Landings** is credited to Mark Way of Darwin Consultancy, with Bordass, Leaman, and Bunn.
...
**The housing-supply debate is live and the evidence has moved. Cite it precisely -- the dates, titles, and even the direction of the effect get swapped routinely, including in earlier versions of this file.**

- **Mast (2021, not 2023)**, the migration-chain study: building 100 new market-rate units causes **45 to 70 people -- not units -- to move *out of* below-median-income tracts**, and 17 to 39 out of bottom-quintile tracts, with almost all of the effect inside **five years**. The direction matters and is easy to invert: people move *out of* lower-income neighbourhoods and into the new buildings at the top of the vacancy chain. Sample is 52,000 tracked residents via address histories. The "six rounds" framing in circulation is **unverified** against the full paper.
- **Rosenthal (2014)**, *American Economic Review* 104(2):687-706 -- the filtering estimate: real annual filtering of **2.5% for rental against 0.5% for owner-occupied**, roughly five times faster for rentals.
- **Been, Ellen, Gedal, Glaeser and McCabe** on historic districts -- note the title changed between working paper ("Preserving History or Hindering Growth?", NBER w20446, 2014) and publication ("Preserving History or **Restricting Development**?", *Journal of Urban Economics*, 2016). Designation raises values inside districts **but only outside Manhattan**, with positive spillover just outside boundaries, and **new construction moderately decreases** after designation.
- **Damiano and Chris Frenier** (not Cody), "Build Baby Build?", *Journal of Urban Affairs*, published online 2026-03-02. The 2026 date is real but the work is not new -- it circulated as a 2020 CURA working paper, which is why it is often cited to the earlier year. **The magnitude and direction of its rent effect are unverified**; the publisher blocked retrieval.
- **Greenaway-McGrevy and So**, "Can Zoning Reform Reduce Housing Costs? Evidence from Rents in Auckland", *Economic Inquiry*, published online 2026-07-11.
...
**The retrofit-first headline claim, with the scope condition that is always dropped.** The "it takes 10 to 80 years for a new efficient building to overcome the climate impact of its construction" figure comes from the Preservation Green Lab's *The Greenest Building* (**2011**), and citing it responsibly requires three things the citations omit:

- **What is being compared.** The new building is **30% more efficient than an average-performing existing building**, over a 75-year study period, across four US climate zones. Change either side of that comparison and the number moves.
- **10 and 80 are the extremes of a seven-row table**, not a typical range. They are a Chicago elementary school and a Portland mixed-use scheme.
- **One of the six typologies returns "Never"** -- warehouse-to-multifamily conversion actually produces a 1 to 6% *greater* impact than new construction in some categories. The authors published this rather than burying it, and it marks the honest boundary of the claim: **reuse wins when the footprint and the use stay put, and can lose when they do not**, because a change of use demands heavy new material input. The report says so directly.

A separate figure gets conflated with the payback range and answers a different question: **savings from reuse are 4 to 46% over new construction when comparing buildings at the same energy performance level.**

Two further honesties. The report states its own limit -- "building reuse alone cannot fulfill the urgent task of reducing climate change emissions" -- and notes the benefit is largest where coal dominates the grid. **That last point cuts in the direction people usually get backwards: as grids decarbonize, operational carbon shrinks as a share of whole-life impact, so reuse's embodied-carbon advantage grows and the payback periods lengthen.** And the provenance matters: this is advocacy-adjacent research, commissioned by a preservation organization, with the New Buildings Institute among its reviewers -- the same NBI whose LEED energy report Scofield reanalysed. The method is documented and the counterexample published, so it is usable; it is not a disinterested academic study and should not be cited as one.

**Get the module structure right, because the common shorthand is incomplete.** The RICS *Whole life carbon assessment for the built environment* professional standard (**2nd edition, September 2023, effective 1 July 2024**) is not the familiar "A1-A5 / B1-B7 / C1-C4 / D". It adds **A0** (pre-construction, assumed zero for buildings and non-zero for infrastructure) and **B8** (other operational and user activities, optional in the whole-life total). Two further points people get wrong: **B2 to B4 -- maintenance, repair, replacement -- are embodied, not operational**, and **D1 and D2 are reported separately** from the whole-life figure rather than netted into it. Whole life carbon is the sum over A0-A5, B1-B7 (B8 optional) and C1-C4, all including biogenic carbon, with D reported alongside.
...
- **2026-09-06 (second pass)** -- Carbon, retrofit, and housing gaps closed from primary sources, with three further corrections to what this file published on 2026-09-05. **Mast is 2021, not 2023, and the migration runs *out of* below-median-income tracts** -- the direction was stated ambiguously before and is easy to invert. **The RICS whole-life module structure includes A0 and B8**, which the common A1-A5/B1-B7/C1-C4/D shorthand omits, and B2-B4 are embodied rather than operational. **The Preservation Green Lab payback range is now sourced** (2011, not 2012) with the scope condition that is always dropped -- it compares against a new build 30% more efficient than an *average-performing* existing building, 10 and 80 are the extremes of a seven-row table, and one of six typologies returns 'Never'. Also separates PROBE's own factor-of-six spread from the 'twice design expectations' claim, which is a different paper resting on a single 1994 US building.
